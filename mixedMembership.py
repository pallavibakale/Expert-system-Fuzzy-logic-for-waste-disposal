...
# Updated Membership Functions for Odor (Gaussian)
...
# Updated Membership Functions for Weather (Trapezoidal)
...
rule5 = ctrl.Rule(odor['strong'] & fullness['high'] & (toxicity['high'] | toxicity['very_high']) & weather['clear'], urgency['high'])
...
rule9 = ctrl.Rule(fullness['medium'] & odor['moderate'] & toxicity['mild'] & weather['rainy'], urgency['medium'])
rule10 = ctrl.Rule(fullness['low'] & odor['strong'] & weather['rainy'] & toxicity['mild'], urgency['medium'])

rule11 = ctrl.Rule(fullness['high'] & (moisture['dry'] | moisture['slightly_moist']) & (toxicity['none'] | odor['none']) & weather['clear'], urgency['low'])
...
rule15 = ctrl.Rule(toxicity['moderate'] & fullness['high'] & (moisture['moderate'] | weather['clear']), urgency['medium'])
...
rule20 = ctrl.Rule(toxicity['mild'] & (odor['mild'] | odor['moderate']) & fullness['medium'] & weather['cloudy'], urgency['medium'])
...
rule26 = ctrl.Rule(moisture['moderate'] & fullness['low'] & odor['mild'] & toxicity['mild'] & weather['cloudy'], urgency['low'])
rule27 = ctrl.Rule(moisture['saturated'] & fullness['high'] & (toxicity['severe'] | odor['very_strong']) & weather['humid'], urgency['high'])
...
rule30 = ctrl.Rule(fullness['high'] & (moisture['wet'] | moisture['saturated']) & weather['humid'] & toxicity['high'], urgency['high'])
...
rule34 = ctrl.Rule(fullness['low'] & toxicity['none'] & moisture['slightly_moist'] & odor['mild'] & weather['clear'], urgency['low'])
rule35 = ctrl.Rule(weather['cloudy'] & fullness['medium'] & odor['mild'], urgency['medium'])
rule36 = ctrl.Rule(fullness['high'] & weather['humid'] & odor['very_strong'], urgency['high'])
rule37 = ctrl.Rule(weather['rainy'] & moisture['wet'] & fullness['medium'], urgency['medium'])
rule38 = ctrl.Rule(odor['moderate'] & moisture['saturated'] & fullness['low'] & weather['cloudy'], urgency['medium'])
...
# Step 4: Plot the updated membership functions
